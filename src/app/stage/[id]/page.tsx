    ...
    return (
      <>
        ...
        <div className="relative z-20 min-h-screen flex items-center justify-center">
          <div className="bg-white/90 backdrop-blur-sm rounded-xl p-8 shadow-2xl border border-white/20">
            <div className="flex items-center justify-center">
              <div className="animate-spin rounded-full h-8 w-8 border-b-2 border-blue-500"></div>
              <span className="ml-3 text-gray-800 font-medium">加载关卡详情中...</span>
            </div>
          </div>
        </div>
      </>
    ...
    return (
      <>
        ...
        <div className="relative z-20 min-h-screen flex items-center justify-center p-4">
          <div className="bg-white/95 backdrop-blur-sm rounded-xl p-8 shadow-2xl border border-white/20 max-w-md w-full text-center">
            ...
            <div className="space-y-3">
              ...
              <a
                href="/stage"
                className="w-full bg-gray-600 text-white px-4 py-2 rounded-lg hover:bg-gray-700 transition-colors inline-block font-medium"
              >
                返回关卡列表
              </a>
            </div>
    ...
    return (
      <>
        ...
        <div className="relative z-20 min-h-screen">
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center space-x-4">
                ...
                <div className="flex items-center space-x-2">
                  <a 
                    href="/"
                    className="bg-white/20 hover:bg-white/30 backdrop-blur-sm text-white px-3 py-1.5 rounded-md transition-colors flex items-center space-x-1 border border-white/30 text-sm hover:scale-105 font-medium"
                  >
                    <span>←</span>
                    <span>首页</span>
                  </a>
          ...
          {/* 关卡详情组件 */}
          <div className="bg-black/10 backdrop-blur-sm rounded-xl mx-4 mb-8">
